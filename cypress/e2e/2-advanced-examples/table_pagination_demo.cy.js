describe("Navigation Tests", () => {
  ...
  context("Actions", () => {
    ...
    it("should navigate to the table pagination example and select show all rows", () => {
      ...
      cy.get('#table-id > tbody > tr:nth-child(30) > td:nth-child(3)')
          .should('contain', 'Frost.Quisque@Nunc.org')
    });
